            ...
            <div class="box box-info">
              <div class="box-body">
                        <table id="dataSiswa" class="table table-bordered table-striped">
                             ...
                             <tbody>
                               <?php $no=1; foreach ($outbox->result() as $row) { ?>
                                 <tr>
                                   <td><?= $no++; ?></td>
                                   <td><?= $row->DestinationNumber; ?></td>
                                   <td><?= $row->SendingDateTime; ?></td>
                                   <td><?= $row->TextDecoded; ?></td>
                                   <td><button class="btn btn-danger btn-xs" data-toggle="modal" data-target="#deletePesan"><i class="fa fa-trash"></i> Hapus</button></td>
                                 </tr>
                               <?php } ?>
                             </tbody>
                         </table>
